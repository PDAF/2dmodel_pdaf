...
!!
subroutine init_parallel_pdaf(screen, COMM_2Dmodel, mype_2Dmodel, npes_2Dmodel)
...
! *** Arguments ***
  ...
  ! Model variables to be modified
  integer, intent(inout) :: COMM_2Dmodel  !< MPI communicator for model tasks
  integer, intent(inout) :: npes_2Dmodel  !< Number of Processs in COMM_model
  integer, intent(inout) :: mype_2Dmodel  !< Process rank in COMM_model

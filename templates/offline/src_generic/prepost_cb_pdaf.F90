...
!!
subroutine prepost_cb_pdaf(step, dim_p, dim_ens, dim_ens_p, dim_obs_p, &
...
! *** local variables ***
  ...
  real, pointer :: obsRMSD_ptr(:)     ! Pointer to array of observation RMSDs
...
! *******************
  ...
  ! Call general output routine to write state, ensemble, variance
...
end subroutine prepost_cb_pdaf
